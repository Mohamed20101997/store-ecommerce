        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('category.create')}}" data-i18n="nav.dash.crypto">أضافة قسم جديد </a>
                    </li>
                </ul>
            </li>
        ...
        <ul class="menu-content">
                        <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">سائل التوصيل</a>
                            <ul class="menu-content">
                                ...
                                <li><a class="menu-item" href="{{ route('edit.shipping.methods','inner') }}" > توصيل داخلي </a></li>
                                <li><a class="menu-item" href="{{ route('edit.shipping.methods','outer') }}" > توصيل خارجي </a></li>
