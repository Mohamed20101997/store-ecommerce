                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('options.edit',$option->id)}}" class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{__('admin/setting.edit')}}</a>
                                                                <form action="{{route('options.destroy' , $option ->id)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')

                                                                    <button  class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">{{__('admin/setting.delete')}}</button>
                                                                </form>
